-- ════════════════════════════════════════════════════════════════════════════
-- LOGISTIQUE V1 — Docs (billets, résas) dans les payloads de partage
-- ════════════════════════════════════════════════════════════════════════════
--
-- Retour Hugo : les documents des trajets/hébergements n'apparaissaient que
-- dans les modales internes — ni dans les fiches « Par personne » partagées,
-- ni sur le lien équipe. Ce patch ajoute la clé 'logistique_docs'
-- (projet_logistique_docs, gated show_personnes) aux DEUX RPCs de partage :
--   - share_logistique_fetch          (lien dédié /share/logistique/:token)
--   - share_projet_logistique_v0_fetch (portail projet multi-pages)
-- Les URLs signées côté client sont couvertes par les policies storage anon
-- déjà posées (20260729b + 20260730c).
--
-- Base : 20260730b + 20260730c (corps identiques + bloc docs). Idempotent.
-- ════════════════════════════════════════════════════════════════════════════
