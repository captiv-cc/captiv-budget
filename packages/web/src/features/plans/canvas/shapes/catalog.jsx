...
export const CATALOG = [
  ...
  },
  {
    ...
    layer: 'lumiere',
    items: [
      { kind: 'fresnel', label: 'Fresnel', glyph: 'fresnel', color: LUM, w: 60, h: 60, tags: ['proj', 'projecteur'], realW: 0.45, realH: 0.45 },
      { kind: 'skypanel_s30', label: 'SkyPanel S30', glyph: 'skypanel', color: LUM, w: 70, h: 60, tags: ['proj', 'panneau', 'arri'], realW: 0.35, realH: 0.32 },
      { kind: 'skypanel_s60', label: 'SkyPanel S60', glyph: 'skypanel', color: LUM, w: 90, h: 74, tags: ['proj', 'panneau', 'arri'], realW: 0.65, realH: 0.35 },
      { kind: 'led_bar', label: 'LED bar', glyph: 'ledbar', color: LUM, w: 110, h: 40, tags: ['barre', 'proj'], realW: 1.0, realH: 0.12 },
      { kind: 'par64', label: 'PAR 64', glyph: 'par', color: LUM, w: 54, h: 54, tags: ['proj'], realW: 0.25, realH: 0.25 },
      { kind: 'moving_head', label: 'Moving head', glyph: 'moving', color: LUM, w: 60, h: 60, tags: ['lyre', 'proj'], realW: 0.45, realH: 0.45 },
      { kind: 'poursuite', label: 'Poursuite', glyph: 'poursuite', color: LUM, w: 70, h: 70, tags: ['spot', 'follow'], realW: 0.7, realH: 0.7 },
    ],
  },
  {
    key: 'son',
    ...
    layer: 'son',
    items: [
      { kind: 'perche', label: 'Perche', glyph: 'perche', color: SON, w: 70, h: 70, realW: 0.6, realH: 0.6 },
      { kind: 'micro_hf', label: 'Micro HF', glyph: 'micro_hf', color: SON, w: 50, h: 56, tags: ['sans fil'], realW: 0.15, realH: 0.15 },
      { kind: 'wedge', label: 'HP scène', glyph: 'wedge', color: SON, w: 64, h: 54, tags: ['hp', 'retour', 'enceinte'], realW: 0.55, realH: 0.45 },
      { kind: 'line_array', label: 'Line array', glyph: 'line_array', color: SON, w: 50, h: 90, tags: ['hp', 'enceinte', 'cluster'], realW: 0.6, realH: 1.2 },
      { kind: 'console_son', label: 'Console son', glyph: 'console', color: SON, w: 90, h: 60, tags: ['mixage', 'façade', 'foh'], realW: 1.4, realH: 0.9 },
    ],
  },
  {
    key: 'personnes',
    ...
    layer: 'personnes',
    items: [
      { kind: 'artiste', label: 'Artiste', glyph: 'personne', color: PER, w: 50, h: 56, realW: 0.6, realH: 0.6 },
      { kind: 'cadreur', label: 'Cadreur', glyph: 'personne', color: CAM, w: 50, h: 56, realW: 0.6, realH: 0.6 },
      { kind: 'regisseur', label: 'Régisseur', glyph: 'personne', color: REG, w: 50, h: 56, realW: 0.6, realH: 0.6 },
      { kind: 'public', label: 'Public', glyph: 'public', color: PER, w: 70, h: 62, realW: 2.0, realH: 2.0 },
    ],
  },
  {
    key: 'structures',
    ...
    layer: 'structures',
    items: [
      { kind: 'truss', label: 'Truss', glyph: 'truss', color: STR, w: 130, h: 46, realW: 3.0, realH: 0.35 },
      { kind: 'mat', label: 'Mât', glyph: 'mat', color: STR, w: 54, h: 54, realW: 0.35, realH: 0.35 },
      { kind: 'grill', label: 'Grill', glyph: 'grill', color: STR, w: 110, h: 110, realW: 4.0, realH: 4.0 },
      { kind: 'podium', label: 'Podium', glyph: 'podium', color: STR, w: 120, h: 80, realW: 2.0, realH: 1.0 },
      { kind: 'ecran_led', label: 'Écran LED', glyph: 'ecran_led', color: STR, w: 130, h: 60, tags: ['mur', 'screen'], realW: 4.0, realH: 0.4 },
      { kind: 'barriere', label: 'Barrière', glyph: 'barriere', color: STR, w: 90, h: 40, realW: 2.0, realH: 0.35 },
    ],
  },
  {
    key: 'regie',
    ...
    layer: 'structures',
    items: [
      { kind: 'regie', label: 'Régie', glyph: 'regie', color: REG, w: 110, h: 80, tags: ['video', 'foh'], realW: 3.0, realH: 2.0 },
      { kind: 'moniteur', label: 'Moniteur', glyph: 'moniteur', color: REG, w: 56, h: 56, realW: 0.6, realH: 0.5 },
      { kind: 'coffret_elec', label: 'Coffret élec', glyph: 'elec', color: REG, w: 54, h: 66, realW: 0.6, realH: 0.4 },
    ],
  },
  {
    key: 'signaletique',
    ...
    layer: 'annotations',
    items: [
      { kind: 'extincteur', label: 'Extincteur', glyph: 'extincteur', color: SEC, w: 44, h: 54, realW: 0.25, realH: 0.25 },
      { kind: 'sortie_secours', label: 'Sortie secours', glyph: 'sortie', color: REG, w: 64, h: 50, realW: 0.8, realH: 0.6 },
      { kind: 'croix_secours', label: 'Poste secours', glyph: 'secours', color: REG, w: 54, h: 54, realW: 0.6, realH: 0.6 },
    ],
  },
]
