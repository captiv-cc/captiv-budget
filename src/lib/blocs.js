...
export const BLOCS_CANONIQUES = [
  { key: 'pre_production',    label: 'PRÉ-PRODUCTION',    defaultRegime: 'Intermittent Technicien', color: '#9c5ffd' },
  { key: 'interpretation',    label: 'INTERPRÉTATION',    defaultRegime: 'Intermittent Artiste',    color: '#ff5ac4' },
  { key: 'production',        label: 'PRODUCTION',        defaultRegime: 'Intermittent Technicien', color: '#00c875' },
  { key: 'moyens_techniques', label: 'MOYENS TECHNIQUES', defaultRegime: 'Technique',               color: '#4d9fff' },
  { key: 'vhr',               label: 'VHR',               defaultRegime: 'Frais',                   color: '#ff9f0a' },
  { key: 'post_production',   label: 'POST PRODUCTION',   defaultRegime: 'Intermittent Technicien', color: '#ff4757' },
...
export function getBlocInfo(catName) {
  ...
  if (idx === -1) return {
    isCanonical: false, canonicalIdx: 999,
    key: catName, label: catName || 'Autre',
    color: '#888', defaultRegime: 'Frais',
  }
