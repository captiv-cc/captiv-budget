...
const TABS = [
  ...
  { key: 'outils',  label: 'Outils',            icon: Wrench, component: () => <Placeholder title="Catalogue d'outils" /> },
  { key: 'org',     label: 'Organisation',      icon: Building2, component: () => <Placeholder title="Informations organisation" /> },
]
...
function Placeholder({ title }) {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center">
      ...
      <p className="text-xs mt-1" style={{ color: 'var(--txt-3)' }}>En cours de construction</p>
    </div>
  )
}
...
export default function Settings() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-semibold" style={{ color: 'var(--txt)' }}>Paramètres</h1>
