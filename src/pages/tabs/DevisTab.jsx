...
export default function DevisTab() {
  ...
  const margeTone = !refStats
    ? 'text-gray-400'
    : refStats.pctMargeFinale > 0.2
      ? 'text-green-600'
      : refStats.pctMargeFinale < 0
        ? 'text-red-600'
        : 'text-amber-600'
          ...
          <div className="card overflow-hidden">
            <div className="p-10 sm:p-14 text-center">
              ...
              <p className="text-sm text-gray-500 max-w-sm mx-auto mb-6">
                Lancez-vous en créant votre première version, vierge ou pré-remplie depuis l&apos;un
                de vos templates.
              </p>
            ...
            <div className="card-header">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {devisList.length} version{devisList.length > 1 ? 's' : ''} — la plus récente en
                  haut
                </p>
              </div>
            </div>
            ...
            <div className="divide-y divide-gray-50">
              {(() => {
                ...
                return [...devisList].reverse().map((dv, idx, arr) => {
                  ...
                  const diffMargePts =
                    s && prevStats ? (s.pctMargeFinale - prevStats.pctMargeFinale) * 100 : null
