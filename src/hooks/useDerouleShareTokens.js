// ════════════════════════════════════════════════════════════════════════════
// useDerouleShareTokens — Hook admin pour la gestion des tokens de partage déroulé
// ════════════════════════════════════════════════════════════════════════════
//
...
//
// Pattern aligné sur useEquipeShareTokens.js.
// Voir src/lib/derouleShare.js pour la lib pure.
// ════════════════════════════════════════════════════════════════════════════
...
import {
  ...
  revokeShareToken,
  updateShareToken,
} from '../lib/derouleShare'

export function useDerouleShareTokens(projectId) {
