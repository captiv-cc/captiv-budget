...
export default function StatusBadgeMenu({
  project,
  onChange,
  canEdit,
  size = 'sm',
  ...
  return (
    <div className="relative inline-block" ref={ref}>
      ...
      {open && (
        <div
          className={`absolute ${align === 'left' ? 'left-0' : 'right-0'} top-full mt-1 z-30 bg-white border border-gray-200 rounded-lg shadow-lg py-1 min-w-[150px]`}
        >
