...
export default function CategoryBlock({ cat, info, num, collapsed, taux, bdd, showAnalyse, remiseVisible, onToggle, onRename, onDelete, onToggleDansMarge, onUpdateNotes, onAddLine, onAddLineDirect, onOpenIntermittent, onUpdateLine, onUpdateLineBatch, onDeleteLine, onDuplicateLine, onReorderLines }) {
